/*
package review.basis.sourcecode.map;

import java.lang.reflect.ParameterizedType;
import java.lang.reflect.Type;
import java.review.util.Map;
import java.review.util.Objects;
import java.review.util.Set;
...
public class MyHashMap1_8<K, V> implements Map<K, V> {
    ...
    static final class TreeNode<K, V> extends MyHashMap1_8.Entry<K, V> {
        TreeNode<K, V> parent;
        TreeNode<K, V> left;
        TreeNode<K, V> right;
        TreeNode<K, V> prev;
        ...
        final TreeNode<K, V> putTreeVal(MyHashMap1_8<K, V> map, Node<K, V>[] tab, int h, K k, V v) {
            Class<?> kc = null;
